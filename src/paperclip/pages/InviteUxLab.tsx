  ...
  return (
    <>
      <div className="flex items-start gap-4">
        ...
        />
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-[0.24em] text-zinc-500">You&apos;ve been invited to join OneEarning</p>
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-400">
          {mode === "sign_up"
            ? "Start with a OneEarning account. After that, you'll come right back here to accept the invite for Acme Robotics."
        ...
        <div className="flex min-h-[420px] flex-col justify-center bg-background px-8 py-10">
          <div className="mx-auto w-full max-w-md">
            <div className="mb-8 flex items-center gap-2">
              ...
              <span className="text-sm font-medium">OneEarning</span>
            </div>
            <h3 className="text-xl font-semibold">
              {mode === "sign_in" ? "Sign in to OneEarning" : "Create your OneEarning account"}
            </h3>
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  This URL includes the current OneEarning domain returned by the server.
                </div>
              </div>
          ...
          <InviteLandingShell
            left={
              <InviteSummaryPanel
                ...
                description="Create your OneEarning account first. If you already have one, switch to sign in and continue the invite with the same email."
