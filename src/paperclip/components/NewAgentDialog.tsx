...
export function NewAgentDialog() {
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      title: t("paperclip.newAgentDialog.ceoIssueTitle"),
      description: t("paperclip.newAgentDialog.ceoIssueDescription"),
    });
  }
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">{t("paperclip.newAgentDialog.header")}</span>
          <Button
            variant="ghost"
            size="icon-xs"
            ...
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  {t("paperclip.newAgentDialog.recommendBody")}
                </p>
              </div>

              <Button className="w-full" size="lg" onClick={handleAskCeo}>
                <Bot className="h-4 w-4 mr-2" />
                {t("paperclip.newAgentDialog.askCeo")}
              </Button>
              ...
              <div className="text-center">
                ...
                >
                  {t("paperclip.newAgentDialog.advancedLink")}
                </button>
              </div>
            </>
          ) : (
            <>
              <div className="space-y-2">
                ...
                >
                  ...
                  {t("paperclip.newAgentDialog.back")}
                </button>
                <p className="text-sm text-muted-foreground">
                  {t("paperclip.newAgentDialog.chooseAdapter")}
                </p>
              </div>
                  ...
                  >
                    {opt.recommended && (
                      <span className="absolute -top-1.5 right-1.5 bg-green-500 text-white text-[9px] font-semibold px-1.5 py-0.5 rounded-full leading-none">
                        {t("paperclip.newAgentDialog.recommendedBadge")}
                      </span>
                    )}
