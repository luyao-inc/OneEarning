...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("paperclip.mobileNav.home"), icon: House },
      { type: "link", to: "/issues", label: t("paperclip.mobileNav.issues"), icon: CircleDot },
      { type: "action", label: t("paperclip.mobileNav.create"), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("paperclip.mobileNav.agents"), icon: Users },
      {
        type: "link",
        to: "/inbox",
        label: t("paperclip.mobileNav.inbox"),
        icon: Inbox,
  ...
  return (
    <nav
      ...
      aria-label={t("paperclip.mobileNav.aria")}
    >
