...
describe("normalizeRememberedInstanceSettingsPath", () => {
  it("keeps known instance settings pages", () => {
    ...
    expect(normalizeRememberedInstanceSettingsPath("/instance/settings/profile")).toBe(
      "/instance/settings/profile",
    );
    expect(normalizeRememberedInstanceSettingsPath("/instance/settings/access")).toBe(
